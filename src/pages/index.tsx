  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock Your Journey with Car Sharing Application - Your Ultimate Platform for Convenient, Sustainable, and Affordable Mobility Solutions."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock Your Journey with Car Sharing Application - Your Ultimate Platform for Convenient, Sustainable, and Affordable Mobility Solutions.`}
            </Text>
            <Box
